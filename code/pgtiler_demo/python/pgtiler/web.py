...
class TornadoServer(object):
	...
	def __init__(self, port=8080, static_path=None, template_path=None, server_conf=None, datasources_conf=None, **kwargs):
		...
		caching = {
			'generate_key': (lambda dataset, srid, tilekey, extension: cache_key_formatstring.format(dataset, srid, tilekey, extension)), 
