...
\kostas{I've changed the symbols used to describe algorithms by removing ``bars'', e.g. $\bar{C} \rightarrow C$. This extra notation cruft is not needed for our purely single level problem definition.}
