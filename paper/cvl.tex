...
\lstdefinelanguage{cvl}{
  morekeywords={generalize,to, with, id, geometry, other, at, zoom, levels, weigh, by, subject, and, create, constraint, as, not, exists, resolve, if, delete, select, from, where, in, order, over,partition, merge, partitions, setup, teardown,force,min,level,for,allornothing,join,on},
  sensitive=false,
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]",
