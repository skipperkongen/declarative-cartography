...
\marcos{Perhaps we should use cellbound here and add a back-reference to Figure~\ref{fig:cvl-example-airports} at the Graphical Output section in the experiments?}

\martin{Remember to change all references to the cellbound constraint to density constraint.}
