...
\martin{Why do we refer to Figure 3 below? Should it be  "e.g." rather than "i.e."? Also note a reference to Figure 3 and the constant 10 in the next paragraph; this is rather confusing since the example in Figure 3 involves constant 16 and the visibility constraint...}
...
%In the CVL example in Figure~\ref{fig:cvl:example:airports}, we referenced the as yet undefined visibility constraint. 
