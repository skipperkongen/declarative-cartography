...
\begin{figure*}[tb]
  ...
  \end{minipage}
  \vspace{-0ex}
  \caption{Performance breakdown by zoom level for complex shapes. Running time is dominated by finding conflicts. Black line indicates number of conflicts} \label{fig:performance:complex}
  \vspace{-2ex}
\end{figure*}
