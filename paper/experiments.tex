...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.7\linewidth]{./figs/scal_pnt_30m_synthetic.png}
...
\begin{figure*}[tb]
  ...
  \end{minipage}
  \vspace{-0ex}
  \caption{Performance breakdown by zoom level. Black line indicates number of conflicts} \label{fig:performance:complex}
  \vspace{-2ex}
\end{figure*}
