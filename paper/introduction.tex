...
\item A CVL compiler that compiles a slightly constrained version of CVL to a two-stage map-reduce program, which makes the CVL scale to almost arbitrary dataset sizes.
