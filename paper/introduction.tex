...
\martin{Is a word missing after "finish processing" below, for example "quickly"?}
...
\martin{Perhaps mention here or in the CVL section that the design of CVL is made in collaboration with GST and/or with inspiration from the requirements of GST?}
