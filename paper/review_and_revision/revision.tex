...
\begin{itemize}
\item R3 says:  Section II: it seems you do not handle "regional labels" that might reappear at more general zoom levels. (Eg, ``Europe'' reappears when the camera pulls out far enough.) That should be made explicit in the text. (also asked by KMS people)
