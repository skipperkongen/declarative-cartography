...
\begin{columns}
	\begin{column}[l]{6cm}
		\begin{itemize}[<+->]
			\item We want records to appear gradually as we zoom in
			\item Maintaining \emph{constant information density}
			\item Without loosing track of visible items as we zoom in
			\item Giving priority to the ``good stuff''
		\end{itemize}
	\end{column}
	\begin{column}[l]{7cm}
    \begin{figure}
        \includegraphics<1>[scale=0.15]{figs/zoom12.pdf}
        \includegraphics<2>[scale=0.15]{figs/zoom13.pdf}
        \includegraphics<3>[scale=0.15]{figs/zoom14.pdf}
        \includegraphics<4>[scale=0.15]{figs/zoom15.pdf}
    \end{figure}                            
\end{column}
\end{columns}
}
