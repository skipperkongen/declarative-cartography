...
\frame[t]
{
	...
	\item \textbf{Problem}: Pick minimum weight set of records on left \\to cover all conflicts on right
...
\frame[t]
{
	...
	\vspace{1em}
	\begin{center}
  		\includegraphics[scale=0.8]{figs/cvl-bipartite-graph-weighted-b.pdf}
  	\end{center}
}
